 ...
 *
 * <p>Tạo bởi adapter {@code YauaaUserAgentParser} (implements {@code UserAgentParser} port). Mọi
 * field đều có thể null nếu yauaa không parse được - không throw, để field null thay vì block luồng
 * login.
 *
