 ...
 * <ul>
 *   <li>PK is a String UUID, generated at the application layer (does not use a DB sequence).</li>
 *   <li>Does NOT inherit from a base entity - has its own timestamps tracking the session lifecycle.</li>
 *   <li>DeviceInfo/GeoLocation from the domain are flattened into separate columns - the mapper
 *   layer (C3) will reconstruct them back into value objects when converting to the domain.</li>
 * </ul>
 */
@Entity
@Table(
